...
def process_song_file(cur, filepath):
    ...
    * filepath the file path to the song file
    ...
    df.artist_id = df.artist_id.apply(str)
...
def process_log_file(cur, filepath):
    ...
    It extracts the logs information in order to store it into the users table,time table and songplays table.
    ...
    * filepath the file path to the log file
    """
    # open log file
    df = df = pd.read_json(filepath,orient="records" ,lines=True)
